...
import umc.spring.apiPayoad.code.ErrorReasonDTO;
...
public enum ErrorStatus implements BaseErrorCode {
    ...
    MISSION_ON_CHALLANGE(HttpStatus.BAD_REQUEST, "MISSION4002", "해당 미션은 이미 도전중입니다."),
    MEMBER_MISSION_NOT_FOUND(HttpStatus.NOT_FOUND, "MISSION4003", "사용자가 해당 미션을 도전중이 아닙니다."),

    // 예시...
    ARTICLE_NOT_FOUND(HttpStatus.NOT_FOUND, "ARTICLE4001", "게시글이 없습니다."),
    TEMP_EXCEPTION(HttpStatus.BAD_REQUEST, "TEMP4001", "이것은 테스트"),
    PAGE_EXCEPTION(HttpStatus.BAD_REQUEST, "TEMP4002", "페이지 값이 음수입니다.");
